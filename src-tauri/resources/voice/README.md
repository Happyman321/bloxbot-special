...
Streaming English 0.6B model, converted to int8 ONNX with 560 ms chunks.
This gives the recognizer more context for word choice than the 160 ms variant,
at the cost of approximately 400 ms more algorithmic buffering.
...
- ONNX conversion: https://huggingface.co/csukuangfj2/sherpa-onnx-nemotron-speech-streaming-en-0.6b-560ms-int8-2026-04-25
